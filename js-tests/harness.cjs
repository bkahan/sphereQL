...
function run(viewerPath, D, opts) {
  ...
  const shim = "\n;globalThis.__vt={parseScene,rebuild,setRuler,rulerAddPick,shareLink,applyViewHash,exportPNG,applyScale,currentSettings," +
    ...
    "decodeTile,catOrder,stratify,tileQuery,InlineSource,ServerSource,TileCache,makeWorkerDecoder,TileStreamer,tileMeshSink,connectToServer,disconnectServer,safeColor,selectStreamRow,renderDiagnostics,get streamStreamer(){return streamStreamer;},get dataSource(){return dataSource;},get _streamFilterOff(){return _streamFilterOff;},get _streamSelectedRow(){return _streamSelectedRow;}," +
